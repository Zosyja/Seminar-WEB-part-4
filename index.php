...
$works = [
    [
        'name' => 'Работа 1',
        'data' => 'Mar 2021 -',
        'text' => 'ldkfja;liurwoeifdvkceirgjgvmcvldifrgjrigjfdvml'
    ],
    [
        'name' => 'Работа 2',
        'data' => 'Dec 2876 - Jan 3000',
        'text' => 'ldkfja;liurwoeifdvkceirgjgvmcvldifrgjrigjfdvml'
    ],
    [
        'name' => 'Работа 3',
        'data' => 'Dec 2006 - Jan 2800',
        'text' => 'ldkfja;liurwoeifdvkceirgjgvmcvldifrgjrigjfdvml'
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[$i]["data"]; ?>
            <?php if ($i==0): ?><span class="w3-tag w3-teal w3-round">Current</span><?php endif ?>
            </h6>
